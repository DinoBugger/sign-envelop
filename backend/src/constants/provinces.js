...
export const PROVINCE_NAME_SET = new Set(PROVINCES.map((province) => province.name));

export const isKnownProvince = (province) => {
  return typeof province === "string" && PROVINCE_NAME_SET.has(province.trim());
};
